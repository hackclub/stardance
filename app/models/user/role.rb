class User
  Role = Data.define(:id, :name, :description) do
    ...
    self::ALL = [
      ...
      new(13, :fraud_fraud_squad_squad, "Everything fraud_dept can do, plus the unified fraud review dashboard: integrity checks, shop orders and fraud flags, per person"),
