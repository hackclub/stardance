module User::StateFlags
  ...
  DISMISSIBLE_THINGS = %w[home_intro flagship_ad willsbuilds_banner shop_picks_intro slack_doodle hardware_update sticky_streak_intro bukux2_intro bukux3_role_reveal].freeze
