class ShopItemCardComponent < ViewComponent::Base
  ...
  def categories
    ...
    when "ShopItem::HCBGrant", "ShopItem::HCBPreauthGrant"
      cats << "Grants" << "Digital"
    when "ShopItem::WarehouseItem", "ShopItem::HQMailItem", "ShopItem::LetterMail",
         "ShopItem::NonmachinableLetterMail", "ShopItem::StickyStreakSticker", "ShopItem::FreeStickers"
      cats << "HQ"
